...
| Move a guide's selectors onto `@grafana/e2e-selectors` | [convert-guide-selectors](.cursor/skills/convert-guide-selectors/SKILL.md) skill | [symbolic-selector-syntax.md](.cursor/skills/convert-guide-selectors/symbolic-selector-syntax.md), [docs/selectors-and-testids.md](docs/selectors-and-testids.md) |
...
- [.cursor/skills/convert-guide-selectors/](.cursor/skills/convert-guide-selectors/SKILL.md) — convert hand-written `reftarget` values to Pathfinder's version-aware `grafana:` symbolic selectors, with a release gate and per-version validation
