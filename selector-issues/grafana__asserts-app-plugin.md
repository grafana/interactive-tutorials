# Stable selectors for Grafana Pathfinder tutorials (11 anchors, 5 tutorials)
...
|---|---|---|
| `div.grid.wb-item:has(p[data-original='KubePodCrashLooping'])` | rca-demo, rca-demo-ops +1 | `src/test/fixtures/k8s_pod_entity.ts:33`<br>`src/test/fixtures/k8s_cluster_entity.ts:31` |
| `div.grid.wb-item:has(p:contains('PostgreSQLHighConnections'))` | rca-demo, rca-demo-ops +1 | `src/test/fixtures/k8s_cluster_entity.ts:91`<br>_low confidence (matched `PostgreSQLHighConnections`)_ |
| `div[role="menu"] button[role="menuitem"]:has(span:contains("Time"))` | rca-demo-ops, rca-demo-v2 | `src/externalComponents/ObservabilityLanding/ObservabilityLanding.tsx:97`<br>`src/features/RcaWorkbench/components/TopMenu.tsx:92`<br>_low confidence (matched `Time`)_ |
| `div[role='dialog'] div[role='group'] div:contains('Frontend')` | rca-demo-ops, rca-demo-v2 | `src/features/ObservabilityHome/widgets/PromoWidget.tsx:39`<br>`src/features/EntityDetails/hooks/useDrawerTabs.tsx:33`<br>_low confidence (matched `Frontend`)_ |
...
| `div[role='dialog'] button[type='button']:has(div:contains('Frontend'))` | rca-demo | `src/features/EntityDetails/hooks/useDrawerTabs.tsx:33`<br>`src/features/EntityDetails/hooks/useDrawerTabs.tsx:34`<br>_low confidence (matched `Frontend`)_ |
