# Stable selectors for Grafana Pathfinder tutorials (16 anchors, 8 tutorials)
...
|---|---|---|
| `[id='pageContent'] a[href='/a/grafana-synthetic-monitoring-app/home']` | detect-outages-synthetic-monitoring-lj/navigate-to-synthetic-monitoring, sm-dns-check-tutorial +3 | `src/plugin.json:46` |
...
| `[aria-label="timeout seconds input"]` | sm-dns-check-tutorial, sm-tcp-check-tutorial | `src/page/NewCheck/__tests__/v2/apiEndpointChecks/gRPCCheck/2-defineUptime.payload.test.tsx:29` |
| `input[name='target'][placeholder='grafana.com']` | detect-outages-synthetic-monitoring-lj/create-ping-check, sm-ping-check-tutorial | `src/configPage/PluginConfigPage/PluginConfigPage.tsx:110`<br>`src/components/ProbeAPIServer/ProbeAPIServer.tsx:37` |
...
| `[aria-label="Query to send 1"]` | sm-tcp-check-tutorial | `src/page/NewCheck/__tests__/v2/apiEndpointChecks/tcpCheck/2-defineUptime.payload.test.tsx:38` |
| `[aria-label="Response to expect 1"]` | sm-tcp-check-tutorial | `src/page/NewCheck/__tests__/v2/apiEndpointChecks/tcpCheck/2-defineUptime.payload.test.tsx:39` |
...
| `input[aria-label='Custom labels 1 name']` | sm-ping-check-tutorial | `src/page/NewCheck/__tests__/v2/apiEndpointChecks/CommonFields.payload.test.tsx:72` |
| `input[aria-label='Custom labels 1 value']` | sm-ping-check-tutorial | `src/components/Checkster/components/form/layouts/GenericLabelContent.test.tsx:109` |
