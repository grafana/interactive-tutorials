...
0. Make sure you've read the best practices and code smells sections in [authoring-guide.mdc](../authoring-guide.mdc) and the decision trees in [best-practices.mdc](../best-practices.mdc), and evaluate the content against those lists, noting BRIEFLY what can be improved.
