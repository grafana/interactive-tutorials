...
0. Make sure you've read the best practices and code smells sections in @authoring-guide.mdc, and evaluate the content against those lists, noting BRIEFLY what can be improved.
