...
5. **Create website metadata files.** Create `website.yaml` for the path and each milestone. Every file needs a non-empty `description`. Refer to `docs/website-yaml-reference.md`.
