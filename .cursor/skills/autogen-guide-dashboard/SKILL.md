...
```yaml
# Auto-generated by autogen-guide-dashboard skill. Do not edit manually.
schema_version: 1
...
- **File path**: read the file directly; copy it to `{guide_dir}/assets/dashboard-source.json`.
- **Pasted JSON**: save to `{guide_dir}/assets/dashboard-source.json` for reference.
